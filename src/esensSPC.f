...
c$$$ calculates ensemble senstivity values
      ...
      real, pointer::uhmaxmean(:)
      real, pointer::dbzmaxmean(:)
...
c$$$  variable arrays
     ...
     &     'mem42/SENS42_' // trim(adjustl(senstime)) // '.out' /)
      ...
      infileR = (/ 
     &     'mem1/R1_' // trim(adjustl(rtime)) // '.out',
     &     'mem2/R2_' // trim(adjustl(rtime)) // '.out',
     &     'mem3/R3_' // trim(adjustl(rtime)) // '.out',
     &     'mem4/R4_' // trim(adjustl(rtime)) // '.out',
     &     'mem5/R5_' // trim(adjustl(rtime)) // '.out',
     &     'mem6/R6_' // trim(adjustl(rtime)) // '.out',
     &     'mem7/R7_' // trim(adjustl(rtime)) // '.out',
     &     'mem8/R8_' // trim(adjustl(rtime)) // '.out',
     &     'mem9/R9_' // trim(adjustl(rtime)) // '.out',
     &     'mem10/R10_' // trim(adjustl(rtime)) // '.out',
     &     'mem11/R11_' // trim(adjustl(rtime)) // '.out',
     &     'mem12/R12_' // trim(adjustl(rtime)) // '.out',
     &     'mem13/R13_' // trim(adjustl(rtime)) // '.out',
     &     'mem14/R14_' // trim(adjustl(rtime)) // '.out',
     &     'mem15/R15_' // trim(adjustl(rtime)) // '.out',
     &     'mem16/R16_' // trim(adjustl(rtime)) // '.out',
     &     'mem17/R17_' // trim(adjustl(rtime)) // '.out',
     &     'mem18/R18_' // trim(adjustl(rtime)) // '.out',
     &     'mem19/R19_' // trim(adjustl(rtime)) // '.out',
     &     'mem20/R20_' // trim(adjustl(rtime)) // '.out',
     &     'mem21/R21_' // trim(adjustl(rtime)) // '.out',
     &     'mem22/R22_' // trim(adjustl(rtime)) // '.out',
     &     'mem23/R23_' // trim(adjustl(rtime)) // '.out',
     &     'mem24/R24_' // trim(adjustl(rtime)) // '.out',
     &     'mem25/R25_' // trim(adjustl(rtime)) // '.out',
     &     'mem26/R26_' // trim(adjustl(rtime)) // '.out',
     &     'mem27/R27_' // trim(adjustl(rtime)) // '.out',
     &     'mem28/R28_' // trim(adjustl(rtime)) // '.out',
     &     'mem29/R29_' // trim(adjustl(rtime)) // '.out',
     &     'mem30/R30_' // trim(adjustl(rtime)) // '.out',
     &     'mem31/R31_' // trim(adjustl(rtime)) // '.out',
     &     'mem32/R32_' // trim(adjustl(rtime)) // '.out',
     &     'mem33/R33_' // trim(adjustl(rtime)) // '.out',
     &     'mem34/R34_' // trim(adjustl(rtime)) // '.out',
     &     'mem35/R35_' // trim(adjustl(rtime)) // '.out',
     &     'mem36/R36_' // trim(adjustl(rtime)) // '.out',
     &     'mem37/R37_' // trim(adjustl(rtime)) // '.out',
     &     'mem38/R38_' // trim(adjustl(rtime)) // '.out',
     &     'mem39/R39_' // trim(adjustl(rtime)) // '.out',
     &     'mem40/R40_' // trim(adjustl(rtime)) // '.out',
     &     'mem41/R41_' // trim(adjustl(rtime)) // '.out', 
     &     'mem42/R42_' // trim(adjustl(rtime)) // '.out' /)
...
c$$$ Response mean allocations
      ...
      allocate(uhmaxmean(numtimes))
      allocate(dbzmaxmean(numtimes))
...
c$$$   response time but can change later
      ...
      print*, cc
      infile = (/ 'mem1/R1_' // trim(adjustl(time)) // '.out',
     &     'mem2/R2_' // trim(adjustl(time)) // '.out',
     &     'mem3/R3_' // trim(adjustl(time)) // '.out',   
     &     'mem4/R4_' // trim(adjustl(time)) //'.out',
     &     'mem5/R5_' // trim(adjustl(time)) //'.out',
     &     'mem6/R6_' // trim(adjustl(time)) //'.out',
     &     'mem7/R7_' // trim(adjustl(time)) //'.out',
     &     'mem8/R8_' // trim(adjustl(time)) //'.out',
     &     'mem9/R9_' // trim(adjustl(time)) //'.out',
     &     'mem10/R10_' // trim(adjustl(time)) // '.out',
     &     'mem11/R11_' // trim(adjustl(time)) // '.out',
     &     'mem12/R12_' // trim(adjustl(time)) // '.out',
     &     'mem13/R13_' // trim(adjustl(time)) // '.out',
     &     'mem14/R14_' // trim(adjustl(time)) // '.out',
     &     'mem15/R15_' // trim(adjustl(time)) // '.out',
     &     'mem16/R16_' // trim(adjustl(time)) // '.out',
     &     'mem17/R17_' // trim(adjustl(time)) // '.out',
     &     'mem18/R18_' // trim(adjustl(time)) // '.out',
     &     'mem19/R19_' // trim(adjustl(time)) // '.out',
     &     'mem20/R20_' // trim(adjustl(time)) // '.out',
     &     'mem21/R21_' // trim(adjustl(time)) // '.out',
     &     'mem22/R22_' // trim(adjustl(time)) // '.out',
     &     'mem23/R23_' // trim(adjustl(time)) // '.out',
     &     'mem24/R24_' // trim(adjustl(time)) // '.out',
     &     'mem25/R25_' // trim(adjustl(time)) // '.out',
     &     'mem26/R26_' // trim(adjustl(time)) // '.out',
     &     'mem27/R27_' // trim(adjustl(time)) // '.out',
     &     'mem28/R28_' // trim(adjustl(time)) // '.out',
     &     'mem29/R29_' // trim(adjustl(time)) // '.out',
     &     'mem30/R30_' // trim(adjustl(time)) // '.out',
     &     'mem31/R31_' // trim(adjustl(time)) // '.out',
     &     'mem32/R32_' // trim(adjustl(time)) // '.out',
     &     'mem33/R33_' // trim(adjustl(time)) // '.out',
     &     'mem34/R34_' // trim(adjustl(time)) // '.out',
     &     'mem35/R35_' // trim(adjustl(time)) // '.out',
     &     'mem36/R36_' // trim(adjustl(time)) // '.out',
     &     'mem37/R37_' // trim(adjustl(time)) // '.out',
     &     'mem38/R38_' // trim(adjustl(time)) // '.out',
     &     'mem39/R39_' // trim(adjustl(time)) // '.out',
     &     'mem40/R40_' // trim(adjustl(time)) // '.out',
     &     'mem41/R41_' // trim(adjustl(time)) // '.out',
     &     'mem42/R42_' // trim(adjustl(time)) // '.out' /)
...
c$$     &     rjx-1,rkx-1,0,icenum)
      ...
      dbzmaxmean(cc)=MAXVAL(dbzresponse(is:ie,js:je,1))
      uhmaxmean(cc)=MAXVAL(uphelresponse(is:ie,js:je))
...
c$$      t=t+tnext
      ...
      dbzmaxmean(cc)=dbzmaxmean(cc)+MAXVAL(dbznext(is:ie,js:je,1))
      uphelresponse=uphelresponse+uhnext
      uhmaxmean(cc)=uhmaxmean(cc)+MAXVAL(uhnext(is:ie,js:je))
c$$      mu=mu+munext
c$$      mub=mub+mubnext
c$$      p=p+pnext
...
c$$      p=p/ensnum
      ...
      dbzmaxmean(cc)=dbzmaxmean(cc)/ensnum
      uphelresponse=uphelresponse/ensnum
      uhmaxmean(cc)=uhmaxmean(cc)/ensnum
      
      print*, "DBZ Max Mean: ", dbzmaxmean(cc)
      print*, "UH Max Mean: ", uhmaxmean(cc)
...
C$$$ Calculate Response functions of choice
...
C$$$ Avg max 10-m winds
      ...
      do i=is,ie
         ...
         enddo
      enddo
      windavg=windavg/((ie-is+1)*(je-js+1))
...
c$$$ Now get all forecast-time response funciton vars
      ...
      print*, 'Current Response Member: ' // infileR(m)
      
      call open_file(infileR(m),permissr,iunitread)
...
C$$$ Avg sim dBZ
      ...
      do i=is,ie
         ...
         enddo
      enddo
      dbzavgMEM=dbzavgMEM/((ie-is+1)*(je-js+1))
...
C$$$ Avg uphel
      ...
      do i=is,ie
         ...
         enddo
      enddo
      uhavgMEM=uhavgMEM/((ie-is+1)*(je-js+1))
...
C$$$ Accum pcp
      ...
      do i=is,ie
         ...
         enddo
      enddo
      pcpMEM=(pcpMEM/((ie-is+1)*(je-js+1)))/25.4
...
C$$$ Avg 10-m winds
      ...
      do i=is,ie
         ...
         enddo
      enddo
      windavgMEM=windavgMEM/((ie-is+1)*(je-js+1))
...
c$$$ Assemble R perts from mean in column vector
      ...
      evec1(2)=dbzmaxMEM-dbzmaxmean(timer)
      evec1(3)=uhavgMEM-uhavg
      evec1(4)=uhmaxMEM-uhmaxmean(timer)
      evec1(5)=pcpMEM-pcp
